...
public class WiFiDirectServicesList extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        /*WiFiP2pService service = (WiFiP2pService)l.getItemAtPosition(position);
        intent = new Intent(this.getActivity(),GroupActivity.class);
        intent.putExtra("member_detail", (Serializable) service);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (service != null) {
                ...
                if (WiFiServiceDiscoveryActivity.mem_info.equals(""))
                    WiFiServiceDiscoveryActivity.mem_info = "not available";
                statusText.setText(getDeviceStatus(service.device.status) + WiFiServiceDiscoveryActivity.mem_info);
